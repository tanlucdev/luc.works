...
const aboutBody = 'I enjoy transforming complex ideas into intuitive digital experiences. My work spans AI workflow systems, product development, frontend architecture, and modern web applications. I believe great software should feel invisible — allowing people to focus on their goals rather than the interface itself.';
  ...
  return (
    <div className="mt-6">
      <WordsPullUpMultiStyle
        segments={[
          { text: "I'm Tan Luc,", className: 'font-normal' },
